...
class Object
  ...
  class Factory
    ...
    def when_creating_a klass, options = {}
      ...
      add_after_create klass, options[:after_create] if options[:after_create]
  ...
  private
    ...
    def add_after_create klass, after_create_block
      @factory_callbacks[symbol_for(klass)] ||= {}
      @factory_callbacks[symbol_for(klass)][:after_create] = after_create_block
    end
